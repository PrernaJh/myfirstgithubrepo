...
PPG.ManageUspsVisnSite = function ($) {
    ...
    const init = function () {
        ...
        _popup = $('#uploadUspsVisnSite-popup').dxPopup('instance');
    ...
    const downloadFile = function (e) {  
        $.ajax({
            url: '/ServiceManagement/DownloadUspsVisnSiteFile',
    ...
    const fileUploader_onValueChanged = function (e) {
        ...
        let ajax = PPG.ajaxer.postFormData('/ServiceManagement/ImportUspsVisnSite', formData);
        ...
        ajax.fail(function (xhr, status) {
            PPG.toastr.error('USPS Visn Site upload failed.');
        });
...
PPG.manageUspsVisnSite = new PPG.ManageUspsVisnSite(jQuery);