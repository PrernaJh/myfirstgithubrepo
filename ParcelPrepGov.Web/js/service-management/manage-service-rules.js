...
PPG.ManageServiceRules = function ($) {
    ...
    let _uploadStartDate = null, _locationLocalDate = null;
    ...
    const exportButton_onClick = function (e) {
        ...
        _ajaxingGrid.start();
        var ajax = PPG.ajaxer.post('/ServiceManagement/GetServiceRulesByActiveGroupId', { id: selectedActiveGroupId, name: _customerName });
        ajax.done(function (response) {
    ...
    const grid_onFocusedRowChanged = function (e) {
        ...
        _downloadFileName = `${_customerName}_service_rules_${month}${day}${year}`;
...
PPG.manageServiceRules = new PPG.ManageServiceRules(jQuery);