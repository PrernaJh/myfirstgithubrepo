...
PPG.ManageUspsRegion = function ($) {
    ...
    const init = function () {
        ...
        _popup = $('#uploadUpsRegions-popup').dxPopup('instance');
    ...
    const downloadFile = function (e) {
        $.ajax({
            url: '/ServiceManagement/DownloadFile',
    ...
    const fileUploader_onValueChanged = function (e) {
        ...
        let ajax = PPG.ajaxer.postFormData('/ServiceManagement/ImportUspsRegions', formData);
        ...
        ajax.fail(function (xhr, status) {
            PPG.toastr.error('USPS Regions upload failed.');
        });
...
PPG.manageUspsRegion = new PPG.ManageUspsRegion(jQuery);