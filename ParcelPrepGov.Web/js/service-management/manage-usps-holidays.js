...
PPG.ManageUspsHolidays = function ($) {
    ...
    const init = function () {
        ...
        _popup = $('#uploadUspsHolidays-popup').dxPopup('instance');
    ...
    const downloadFile = function (e) {  
        $.ajax({
            url: '/ServiceManagement/DownloadUspsHolidayFile',
    ...
    const fileUploader_onValueChanged = function (e) {
        ...
        let ajax = PPG.ajaxer.postFormData('/ServiceManagement/ImportUspsHolidays', formData);
        ...
        ajax.fail(function (xhr, status) {
            PPG.toastr.error('USPS Holidays upload failed.');
        });
...
PPG.manageUspsHolidays = new PPG.ManageUspsHolidays(jQuery);