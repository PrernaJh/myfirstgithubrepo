/****** Object:  StoredProcedure [dbo].[getRptDailyContainer_master]    Script Date: 1/27/2022 1:15:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER   PROCEDURE [dbo].[getRptDailyContainer_master]
(
...
/****** Object:  StoredProcedure [dbo].[getRptDailyContainer_detail]    Script Date: 1/27/2022 1:15:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER   PROCEDURE [dbo].[getRptDailyContainer_detail]
(
    -- Add the parameters for the stored procedure here
	@siteName VARCHAR(MAX),
    @manifestDate AS DATE,
